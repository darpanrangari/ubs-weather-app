...
2. If already added to favorites then button will be replaced with text "Added to Favorites"
3. User can see 5 days of forecast data.
4. Debounced input search which reduces multiple api calls.
...
6. weatherCode-image mapping used to have exact image of the weather in current time in the given location.
7. SVGs are used for graphic as will fit for all the devices.
...
5. Should be more responsive to smaller viewport.
